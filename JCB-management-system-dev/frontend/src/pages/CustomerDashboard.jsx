...
const CustomerDashboard = () => {
      ...
      if (error.response) {
        ...
        if (error.response.data) {
          ...
          if (errorMessage.includes('foreign key constraint')) {
            errorMessage = 'Cannot cancel booking because it has associated reviews. Please delete reviews first.';
          }
  ...
  return (
    <Layout>
      ...
      {/* Edit Review Modal */}
      {showEditReviewModal && selectedReviewForEdit && (
        <EditReviewModal
